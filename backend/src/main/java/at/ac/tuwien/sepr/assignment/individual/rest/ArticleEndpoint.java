...
public class ArticleEndpoint {
    ...
    @PostMapping()
    public ResponseEntity<ArticleDetailDto> create(@RequestBody ArticleCreateDto dto) throws ValidationException, ConflictException, NotFoundException {
        LOG.info("POST " + BASE_PATH);
        LOG.debug("request parameters: {}", dto);
        System.out.println("request parameters: " + dto);

        ArticleDetailDto createdArticle = articleService.create(dto);
